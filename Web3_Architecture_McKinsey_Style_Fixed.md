...
graph TB
    ...
    %% L5: 接入层
    subgraph L5 ["🚪 L5: 接入层<br/>用户与Web3交互的合规入口"]
    ...
    %% L3: 组件层
    subgraph L3 ["🧩 L3: 组件层<br/>封装金融协议与开发者工具"]
    ...
    %% L2: 中间件层
    subgraph L2 ["⚙️ L2: 中间件层<br/>扩展性能、跨链互通、链下数据接入"]
    ...
    %% L1: 区块链层
    subgraph L1 ["⛓️ L1: 区块链层<br/>价值结算与智能合约执行"]
    ...
    %% L0: 物理设施层
    subgraph L0 ["🏗️ L0: 物理设施层<br/>提供分布式网络基础资源"]
...
**编辑说明：**
1. 本图使用Mermaid语法，支持UTF-8中文编码
2. 标有⭐的为核心关键技术
3. 各层级按重要性和技术先进性排序
4. 可通过修改classDef调整颜色主题
5. 支持导出为PNG、SVG等格式
6. 在支持Mermaid的平台中可直接渲染显示
